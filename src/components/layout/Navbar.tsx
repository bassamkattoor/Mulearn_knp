...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl sm:backdrop-blur-2xl bg-[#06060e]/90 border-b border-indigo-500/20 shadow-2xl transition-all">
